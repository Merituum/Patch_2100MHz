...
<MetaResultFile version="20211011" creator="Solver HFTD - Field 3DFD Monitor">
  ...
  <SimulationProperties fieldname="e-field (f=1800) [1]" frequency="1800" encoded_unit="&amp;U:V^1.:m^-1" quantity="e-field" fieldtype="E-Field" fieldscaling="PEAK" dB_Amplitude="20">
    <SecondaryResults>
      <SecondaryResult name="loss (f=1800)_1.rex"/>
      <SecondaryResult name="power (f=1800)_1.rex"/>
    </SecondaryResults>
